    ...
    return (
        <Drawer PaperProps={{
         ...
         <Divider sx={{
          ...
          {[{title: 'Targets', icon: Targets, link: "/targets"} , {title: 'Settings', icon: Settings, link: "/"}, {title: 'Account', icon: Account, link: "/"}].map(({title, icon: Icon, link}) => (
            <ListItem key={title} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListTitle primary={title} sx={{ 
                  
                  opacity: open ? 1 : 0, color: "#fff" }} />
              </ListItemButton>
            </ListItem>
          ))}
        </List>
