  ...
  getVarsSourceHandler(): VarsSourceHandler {
    if (this.varsSource.values) {
      ...
      return {
        ...
        sourceProps: () => [{ name: "File", value: this.varsSource.file }],
      };
      ...
      this.varsSource.clusterConfigMap ||
      this.varsSource.clusterSecret
    ) {
      const vs = (
        this.varsSource.clusterConfigMap
          ? this.varsSource.clusterConfigMap
      ...
      const icon = this.varsSource.clusterConfigMap ? (
      ...
      return {
        ...
        sourceProps: () => {
          ...
          sourceProps.push({
            name: "Method",
            value: this.varsSource.http!.method || "GET",
          });
          if (this.varsSource.http!.jsonPath) {
            sourceProps.push({
              name: "JsonPath",
              value: this.varsSource.http!.jsonPath,
            });
          }
          return sourceProps;
        },
      ...
      return {
        ...
        sourceProps: () => {
          ...
          sourceProps.push({
            name: "SecretName",
            value: this.varsSource.awsSecretsManager!.secretName,
          });
          if (this.varsSource.awsSecretsManager!.region) {
            sourceProps.push({
              name: "Region",
              value: this.varsSource.awsSecretsManager!.region,
            });
          }
          if (this.varsSource.awsSecretsManager!.profile) {
            sourceProps.push({
              name: "Profile",
              value: this.varsSource.awsSecretsManager!.profile,
            });
          }
          return sourceProps;
        },
      ...
      return {
        ...
        sourceProps: () => {
          ...
          sourceProps.push({
            name: "Address",
            value: this.varsSource.vault!.address,
          });
          sourceProps.push({
            name: "Path",
            value: this.varsSource.vault!.path,
          });
          return sourceProps;
        },
      };
