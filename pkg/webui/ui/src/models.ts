...
export class DeploymentItemConfig {
  ...
  constructor(source: any = {}) {
    ...
    this.deleteObjects = this.convertValues(
      source["deleteObjects"],
      DeleteObjectItemConfig
    );
    this.when = source["when"];
    this.renderedHelmChartConfig = this.convertValues(
      source["renderedHelmChartConfig"],
      HelmChartConfig
    );
    this.renderedObjects = this.convertValues(
      source["renderedObjects"],
      ObjectRef
    );
    this.renderedInclude = this.convertValues(
      source["renderedInclude"],
...
export class VarsSource {
  ...
  constructor(source: any = {}) {
    ...
    this.clusterConfigMap = this.convertValues(
      source["clusterConfigMap"],
      VarsSourceClusterConfigMapOrSecret
    );
    this.clusterSecret = this.convertValues(
      source["clusterSecret"],
      VarsSourceClusterConfigMapOrSecret
    );
    this.systemEnvVars = source["systemEnvVars"];
    this.http = this.convertValues(source["http"], VarsSourceHttp);
    this.awsSecretsManager = this.convertValues(
      source["awsSecretsManager"],
      VarsSourceAwsSecretsManager
    );
...
export class DeploymentProjectConfig {
  ...
  constructor(source: any = {}) {
    if ("string" === typeof source) source = JSON.parse(source);
    this.vars = this.convertValues(source["vars"], VarsSource);
    this.sealedSecrets = this.convertValues(
      source["sealedSecrets"],
      SealedSecretsConfig
    );
    this.when = source["when"];
    this.deployments = this.convertValues(
      source["deployments"],
    ...
    this.tags = source["tags"];
    this.ignoreForDiff = this.convertValues(
      source["ignoreForDiff"],
      IgnoreForDiffItemConfig
    );
  }
...
export class Target {
  ...
  constructor(source: any = {}) {
    ...
    this.args = source["args"];
    this.sealingConfig = this.convertValues(
      source["sealingConfig"],
      SealingConfig
    );
...
export class CommandInfo {
  ...
  constructor(source: any = {}) {
    ...
    this.kluctlDeployment = this.convertValues(
      source["kluctlDeployment"],
...
export class ProjectKey {
  ...
  constructor(source: any = {}) {
    if ("string" === typeof source) source = JSON.parse(source);
    this.normalizedGitUrl = source["normalizedGitUrl"];
    this.subDir = source["subDir"];
  }
}
export class CommandResult {
  ...
  constructor(source: any = {}) {
    ...
    this.deployment = this.convertValues(
      source["deployment"],
      DeploymentProjectConfig
    );
...
export class TargetSummary {
  ...
  constructor(source: any = {}) {
    if ("string" === typeof source) source = JSON.parse(source);
    this.target = this.convertValues(source["target"], TargetKey);
    this.lastValidateResult = this.convertValues(
      source["lastValidateResult"],
      ValidateResult
    );
    this.commandResults = this.convertValues(
